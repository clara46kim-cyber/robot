export const parts = [
  ...
  },
  {
    ...
    color: '#ed1c24',
    menuTitle: '로봇의 역사',
    intro: '안녕! 나는 티마야. 로봇이라는 말의 탄생부터 초기 인간형 로봇까지 시간여행을 떠나 보자!',
    type: 'quiz',
    questions: [
      {
        kind: 'choice',
      ...
      {
        kind: 'choice',
        question: '1939년 뉴욕 세계박람회에 등장한 초기 인간형 로봇은 무엇일까요?',
  ...
  },
  {
    ...
    color: '#f8a719',
    menuTitle: '로봇과 상상하기',
    intro: '안녕! 나는 티나야. 정답은 없어. 우리 생활에 필요한 미래 로봇을 자유롭게 상상해 보자!',
    type: 'imagine',
    prompts: [
      ...
      { key: 'job', label: '로봇이 하는 일을 자세히 적어 보세요.', placeholder: '예: 위험한 곳을 살펴보고 사람에게 알려 줍니다.' },
      { key: 'feature', label: '꼭 필요한 특별한 기능은 무엇인가요?', placeholder: '예: 사람의 목소리를 알아듣는 기능' }
    ]
  }
]
